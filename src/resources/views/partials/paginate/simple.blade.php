{{--@if ($paginator->hasPages())--}}
    <div class="card-footer bg-gray-lightest">
        <div class="row" role="navigation">
            ...
            @else
                <div class="col-sm-3">
                    <a href="{{ $paginator->previousPageUrl() }}" class="text-gray text-decoration-none" rel="prev">@lang('pagination.previous')</a>
                </div>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <div class="col-sm-3 text-right">
                    <a href="{{ $paginator->nextPageUrl() }}" class="text-gray text-decoration-none" rel="next">@lang('pagination.next')</a>
                </div>
            @else
